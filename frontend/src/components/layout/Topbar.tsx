  ...
  return (
    <header className="flex items-center justify-between border-b border-white/20 bg-white/70 px-4 py-4 backdrop-blur-md sm:px-6">
      ...
      <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
        <Link
          to="/"
          className="flex items-center gap-1.5 rounded-xl border border-navy-200 bg-navy-50 px-2.5 py-2 text-sm
            font-semibold text-navy-700 transition-all duration-300 hover:scale-[1.02] hover:bg-navy-100
            active:scale-[0.98] sm:px-3"
        ...
        <button
          onClick={logout}
          className="flex items-center gap-1.5 rounded-xl bg-rose-600 px-2.5 py-2 text-sm font-semibold text-white
            shadow-sm transition-all duration-300 hover:scale-[1.02] hover:bg-rose-700 active:scale-[0.98] sm:px-3"
          title="تسجيل الخروج"
        >
          <LogOut size={16} />
