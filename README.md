...
- **بحث حجوزات طيران حقيقي**: عبر Amadeus for Developers (يتطلّب
  `AMADEUS_API_KEY`/`AMADEUS_API_SECRET` فعليَين، فارغين حتى الآن) —
  يعرض للعميل رحلات وأسعار حقيقية بين أي مدينتين، مع رسم حجز يضيفه
  المدير فوق السعر الحقيقي (فلات بالدولار أو نسبة مئوية، قابل للتعديل
  في أي وقت). الحجز الفعلي (إصدار التذكرة) يبقى يدوياً كما هو الحال في
  بقية الخدمات. كل طلب يتطلّب رقم واتساب للتواصل السريع مع العميل.
