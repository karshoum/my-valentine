...
التصميم في `docs/UI_DESIGN_GUIDELINES.md`. تشمل حالياً سبع شاشات كاملة:
تسجيل الدخول، لوحة التحكم الرئيسية (كروت KPI وجدول طلبات تفاعلي)،
الطلبات (إنشاء طلب جديد ورفع إثبات الدفع)، المدفوعات (طابور مراجعة
يدوية للموظف/المدير)، الوكلاء (B2B)، الخدمات (كتالوج كامل مع
إضافة/تعديل/حذف/عروض خصم محدودة المدة)، العملات وسعر الصرف، وحسابي
(بيانات شخصية وتغيير كلمة المرور). دورة حياة الطلب الكاملة — من
الإنشاء، مروراً بالدفع والمراجعة اليدوية والمعالجة الخارجية، وصولاً
لرفع المستند النهائي (تذكرة/فيزا) واكتمال الطلب — مبنية ومُختبرة
حياً عبر المتصفح.
