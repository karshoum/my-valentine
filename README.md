...
التصميم في `docs/UI_DESIGN_GUIDELINES.md`. تشمل حالياً ست شاشات كاملة:
تسجيل الدخول، لوحة التحكم الرئيسية (كروت KPI وجدول طلبات تفاعلي)،
الطلبات، الوكلاء (B2B)، العملات وسعر الصرف، الخدمات (كتالوج كامل مع
إضافة/تعديل/حذف/عروض خصم محدودة المدة)، وحسابي (بيانات شخصية وتغيير
كلمة المرور).
