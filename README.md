...
التصميم في `docs/UI_DESIGN_GUIDELINES.md`. تشمل حالياً: شاشة تسجيل
الدخول، هيكل لوحة التحكم (قائمة جانبية + شريط علوي مرتبطان بدور
المستخدم)، ولوحة تحكم رئيسية بكروت مؤشرات أداء (KPI) وجدول طلبات تفاعلي
مع شارات حالة نابضة وفلاتر سريعة. الشاشات التفصيلية (الطلبات، الوكلاء،
العملات) لا تزال قيد الإنشاء في مراحل قادمة.
