...
التصميم في `docs/UI_DESIGN_GUIDELINES.md`. تشمل حالياً ثماني شاشات
كاملة: تسجيل الدخول، لوحة التحكم الرئيسية (كروت KPI وجدول طلبات
تفاعلي)، الطلبات (إنشاء طلب جديد ورفع إثبات الدفع)، المدفوعات (طابور
مراجعة يدوية للموظف/المدير)، المستردات (طابور اعتماد/رفض/تنفيذ
للمدير)، الوكلاء (B2B)، الخدمات (كتالوج كامل مع إضافة/تعديل/حذف/عروض
خصم محدودة المدة)، العملات وسعر الصرف، وحسابي (بيانات شخصية وتغيير
كلمة المرور). دورة حياة الطلب الكاملة — من الإنشاء، مروراً بالدفع
والمراجعة اليدوية والمعالجة الخارجية، ورفع المستند النهائي (تذكرة/فيزا)،
وحتى الاسترداد إن لزم — مبنية ومُختبرة حياً عبر المتصفح.
